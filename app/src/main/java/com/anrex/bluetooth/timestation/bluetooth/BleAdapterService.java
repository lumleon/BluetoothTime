...
public class BleAdapterService extends Service {
    ...
    public static String IMMEDIATE_ALERT_SERVICE_UUID = "0000ffe0-0000-1000-8000-00805f9b34fb";
    public static String LINK_LOSS_SERVICE_UUID = "0000ffe0-0000-1000-8000-00805f9b34fb";
    public static String TX_POWER_SERVICE_UUID = "0000ffe0-0000-1000-8000-00805f9b34fb";
    public static String PROXIMITY_MONITORING_SERVICE_UUID = "0000ffe0-0000-1000-8000-00805f9b34fb";
    // service characteristics
    public static String ALERT_LEVEL_CHARACTERISTIC = "0000ffe1-0000-1000-8000-00805f9b34fb";
    public static String CLIENT_PROXIMITY_CHARACTERISTIC = "0000ffe1-0000-1000-8000-00805f9b34fb";
    ...
    public boolean connect(final String address) {
        if (bluetooth_adapter == null || address == null) { sendConsoleMessage("connect: bluetooth_adapter=null");
            return false;
        }
        device = bluetooth_adapter.getRemoteDevice(address); if (device == null) {
    ...
    public void disconnect() {
        ...
        if (bluetooth_adapter == null || bluetooth_gatt == null) {
            ...
            return; }
        if (bluetooth_gatt != null) { bluetooth_gatt.disconnect();
        }
    }
    ...
    private final BluetoothGattCallback gatt_callback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
            Bundle bundle = new Bundle(); bundle.putString(PARCEL_CHARACTERISTIC_UUID, characteristic.getUuid()
                    .toString());
            bundle.putString(PARCEL_SERVICE_UUID, characteristic.getService().getUuid().toString());
            bundle.putByteArray(PARCEL_VALUE, characteristic.getValue()); Message msg = Message.obtain(activity_handler,
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                Message msg = Message.obtain(activity_handler, GATT_CHARACTERISTIC_WRITTEN); msg.setData(bundle);
                msg.sendToTarget();
            } else {
    ...
    public boolean readCharacteristic(String serviceUuid, String characteristicUuid) {
        ...
        if (bluetooth_adapter == null || bluetooth_gatt == null) { sendConsoleMessage("readCharacteristic: bluetooth_adapter|bluetooth_gatt null"); return false;
        }
        BluetoothGattService gattService = bluetooth_gatt .getService(java.util.UUID.fromString(serviceUuid));
        if (gattService == null) { sendConsoleMessage("readCharacteristic: gattService null"); return false;
        }
        BluetoothGattCharacteristic gattChar = gattService
                .getCharacteristic(java.util.UUID.fromString(characteristicUuid)); if (gattChar == null) {
